...
if (isset($_POST['submit'])) 
{
   ...
   if(isset($_POST['hidden-total-price']))
   {
    ...
    $insertQuery ="INSERT INTO dry_cleaning(Name, Address,Phone,SelectedItem,Weight,TotalPrice,PickupDate,PickupTime,DeliveryDate,DeliveryTime) VALUES('$name','$address','$phone','$selectedItem','$weight','$totalPrice','$pickupdate','$pickuptime','$deliverydate','$deliverytime')";
